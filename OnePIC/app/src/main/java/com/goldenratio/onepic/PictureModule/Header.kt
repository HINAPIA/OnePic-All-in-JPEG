...
//        textContentInfo = TextContentInfo(MCContainer.textContent)
        textContentInfo = TextContentInfo(MCContainer.textContent, imageContentInfo.getEndOffset())
        audioContentInfo = AudioContentInfo(MCContainer.audioContent, textContentInfo.getEndOffset())
